...
#define k_STATE_HEAHERVIEW_HEIGHT         40
#define k_STATE_FOOTERVIEW_HEIGHT         95
#define k_STATE_VIEW_HEIGHT         95    //  视图窗体：视图高度 默认40
...
//@property (nonatomic, retain) SvGifView *gifView;
